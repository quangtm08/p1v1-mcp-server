 ...
 * 
 * Usage: node tests/test-webhook.js [WEBHOOK_URL]
 * Example: node tests/test-webhook.js https://your-webhook.herokuapp.com
 */
...
async function testWebhook() {
  ...
  try {
    ...
    console.log(`   - Visit: ${WEBHOOK_URL}/auth/callback`);
